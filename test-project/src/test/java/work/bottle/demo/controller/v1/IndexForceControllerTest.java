...
@SpringBootTest(classes = HotelBaseServiceStartup.class, webEnvironment = SpringBootTest.WebEnvironment.RANDOM_PORT, properties = {"bt-response.force=true"})
@AutoConfigureMockMvc
class IndexForceControllerTest {
    private static final Logger logger = LoggerFactory.getLogger(IndexForceControllerTest.class);
...
//    private WebApplicationContext context;
    ...
    public void testRetStr() throws Exception {
        ...
        Assert.assertEquals("返回字符串测试(/index/v1/ret/str), 结果异常", "{\"success\":true,\"code\":0,\"data\":\"hello world\",\"message\":\"\"}", contentAsString);
    }
    ...
    public void testRetStrCn() throws Exception {
        ...
        Assert.assertEquals("返回中文字符串测试(" + uri + "), 结果异常", "{\"success\":true,\"code\":0,\"data\":\"你好, 朋友\",\"message\":\"\"}", contentAsString);
    }
    ...
    public void testRetByteArr() throws Exception {
        ...
        Assert.assertEquals("返回Byte[]<{0x69, 0x70}(ip)>(GET " + uri + "), 结果异常", "{\"success\":true,\"code\":0,\"data\":\"aXA=\",\"message\":\"\"}", contentAsString);
    }
    ...
    public void testRetNull() throws Exception {
        ...
        Assert.assertEquals("返回Object<null>测试(GET " + uri + "), 结果异常", "{\"success\":true,\"code\":0,\"data\":null,\"message\":\"\"}", contentAsString);
    }
    ...
    public void testNobj() throws Exception {
        ...
        Assert.assertEquals("返回Object<new Object>测试(GET " + uri + "), 结果异常", "{\"success\":true,\"code\":0,\"data\":{},\"message\":\"\"}", contentAsString);
    }
